...
Arc is a data-driven action mod library specifically designed for mod developers in Minecraft. This library enables developers to incorporate actions, conditions, and rewards into their own mods, providing a seamless and customizable experience for players.
